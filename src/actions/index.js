...
export const logOutUser = (userId) => ({ type: 'USER_LOGOUT_REQUESTED', payload: { userId } })
export const verifyUser = (userId) => ({ type: 'VERIFY_USER_REQUESTED', payload: { userId } })
export const fetchUser = (userId) => ({ type: 'USER_FETCH_REQUESTED', payload: { userId } })
...
export const updateSearchBarValue = (keyword) => ({ type: 'UPDATE_SEARCH_BAR_VALUE', payload: { keyword } })
